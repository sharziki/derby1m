    ...
    <div className="mx-auto max-w-[1100px] px-5 py-10 md:px-8 md:py-16">
      <header className="mb-12 border-b border-paper-200 pb-10">
        ...
        <h1 className="mt-4 font-display text-[44px] italic leading-[1.05] text-ink-900 md:text-[64px]">
          What we said,
          <br />
          <span className="text-ink-700">what happened.</span>
        </h1>
        <p className="mt-5 max-w-2xl text-[16px] leading-relaxed text-ink-700">
          The model&apos;s pre-race P(win) distribution next to the actual finish
          order. Brier score, log-loss, and where the shape of the prediction
          agreed or diverged from the morning line.
        </p>
      </header>
